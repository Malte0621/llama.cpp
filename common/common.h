...
struct common_params_diffusion {
    int32_t steps         = 128;
    int32_t blocks        = 0;        // max block-autoregressive denoising blocks (0 = automatic)
    ...
    int32_t eb_kv_cache      = 0;     // prefix KV cache: 0=auto (on for single-device canvas), 1=on, 2=off
    int32_t eb_gpu_sampling  = 0;     // device-resident SC: 0=auto, 1=on, 2=off
    int32_t eb_gpu_sample_reduce = 0; // device argmax/entropy/sample reduction: 0=auto, 1=on, 2=off
};
