...
// Uses O(d log d) WHT instead of O(d^2) dense matvec (18x fewer operations)
...
// O(n log n) = 896 operations for n=128, vs O(n^2) = 16384 for dense matvec
...
// up to 32x per block (once per 4-element chunk). We cache the full
...
// Non-vec: 16 elements per call (il in {0,1}), returns type4x4
template <typename type4x4>
...
// Vec: 4 elements per call (il in {0..7}), returns type4
template <typename type4>
            ...
            // Q*K^T
            {
                ...
                FOR_UNROLL (short cc = 0; cc < C/NE; ++cc) {
                    if (is_same<kd4_t, k4_t>::value) {
                        ...
                        //
                        // 4 centroid iterations x masked Q accumulation replaces
                        ...
                        // Threads 0-3 within the block each hold one magxnorm value.
...
// TurboQuant vec flash attention: symmetric, cross-Turbo, and q8_0/Turbo K/V.
...
template [[host_name("kernel_set_rows_f32_i64_turbo3_0")]] kernel set_rows_turbo3_t kernel_set_rows_turbo<int64_t, block_turbo3_0, QK_TURBO3, quantize_turbo3_0>;
template [[host_name("kernel_set_rows_f32_i32_turbo3_0")]] kernel set_rows_turbo3_t kernel_set_rows_turbo<int32_t, block_turbo3_0, QK_TURBO3, quantize_turbo3_0>;

typedef decltype(kernel_set_rows_turbo2<int64_t>) set_rows_turbo2_t;
template [[host_name("kernel_set_rows_f32_i64_turbo2_0")]] kernel set_rows_turbo2_t kernel_set_rows_turbo2<int64_t>;
template [[host_name("kernel_set_rows_f32_i32_turbo2_0")]] kernel set_rows_turbo2_t kernel_set_rows_turbo2<int32_t>;

typedef decltype(kernel_set_rows_turbo4<int64_t>) set_rows_turbo4_t;
template [[host_name("kernel_set_rows_f32_i64_turbo4_0")]] kernel set_rows_turbo4_t kernel_set_rows_turbo4<int64_t>;
template [[host_name("kernel_set_rows_f32_i32_turbo4_0")]] kernel set_rows_turbo4_t kernel_set_rows_turbo4<int32_t>;
