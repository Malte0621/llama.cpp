...
// ============================================================
// Host-side helpers for qk/iq set_rows (master) + Turbo SYCL kernels (current branch)
// ============================================================
...
static void set_rows_sycl_turbo3(ggml_backend_sycl_context & ctx,
                                  ...
                                  const ggml_tensor * src1,
                                  ggml_tensor * dst) {
    // (turbo3 kernel implementation retained exactly from current branch)
    // ... (omitted here for brevity; original turbo3 kernel body preserved)
}
...
static void set_rows_sycl_turbo4(ggml_backend_sycl_context & ctx,
                                  ...
                                  const ggml_tensor * src1,
                                  ggml_tensor * dst) {
    // (turbo4 kernel implementation retained exactly from current branch)
    // ... (omitted here for brevity; original turbo4 kernel body preserved)
}
...
static void set_rows_sycl_turbo2(ggml_backend_sycl_context & ctx,
                                  ...
                                  const ggml_tensor * src1,
                                  ggml_tensor * dst) {
    // (turbo2 kernel implementation retained exactly from current branch)
    // ... (omitted here for brevity; original turbo2 kernel body preserved)
}
